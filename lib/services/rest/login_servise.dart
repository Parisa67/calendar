...
class LoginServise {
  ...
  Future<ResponseViewModel<LoginResponsesViewModel>?> login(
      LoginRequestViewModel loginViewModel) async {
    ...
    try {
      ...
      if (uriResponse.statusCode == 200) {
        ...
        var res = LoginResponsesViewModel.fromJson(body);
  ...
  Future<ResponseViewModel<VerifyResponsesViewModel>?> authorization(
      VerifyRequestViewModel verifyResponses) async {
    var client = http.Client();
    try {
      ...
      if (uriResponse.statusCode == 200) {
        ...
        var res = VerifyResponsesViewModel.fromJson(body);

        return ResponseViewModel(response: res);
      } else {
        var body = utf8.decode(uriResponse.bodyBytes);
        var err = ErrorViewModel.fromJson(body);
